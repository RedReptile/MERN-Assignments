...
const { addBook, updateBook, updateBookPartial, getBooks, getBookById, deleteBook } = require('../Controllers/bookControllers');
const auth = require('../Middleware/authMiddleware');
const authorizeRole = require('../Middleware/authorizeRoleMiddleware');
const { bookImage } = require('../Middleware/uploadMiddleware'); // Correct import here
